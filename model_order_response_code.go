...
// checks if the OrderResponseCode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderResponseCode{}

// OrderResponseCode Order response code
type OrderResponseCode struct {
...
type _OrderResponseCode OrderResponseCode
...
func (o OrderResponseCode) MarshalJSON() ([]byte, error) {
...
func (o OrderResponseCode) ToMap() (map[string]interface{}, error) {
...
func (o *OrderResponseCode) UnmarshalJSON(data []byte) (err error) {
	...
	varOrderResponseCode := _OrderResponseCode{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOrderResponseCode)

	if err != nil {
		return err
	}

	*o = OrderResponseCode(varOrderResponseCode)

	return err
}

type NullableOrderResponseCode struct {
	value *OrderResponseCode
	isSet bool
}

func (v NullableOrderResponseCode) Get() *OrderResponseCode {
	return v.value
}

func (v *NullableOrderResponseCode) Set(val *OrderResponseCode) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderResponseCode) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderResponseCode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderResponseCode(val *OrderResponseCode) *NullableOrderResponseCode {
	return &NullableOrderResponseCode{value: val, isSet: true}
}

func (v NullableOrderResponseCode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderResponseCode) UnmarshalJSON(src []byte) error {
	v.isSet = true
