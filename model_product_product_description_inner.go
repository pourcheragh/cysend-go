...
// checks if the ProductProductDescriptionInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductProductDescriptionInner{}

// ProductProductDescriptionInner A prepaid product description in a specific language
type ProductProductDescriptionInner struct {
...
type _ProductProductDescriptionInner ProductProductDescriptionInner
...
func NewProductProductDescriptionInner(language string, text string) *ProductProductDescriptionInner {
	this := ProductProductDescriptionInner{}
...
func (o ProductProductDescriptionInner) MarshalJSON() ([]byte, error) {
...
func (o ProductProductDescriptionInner) ToMap() (map[string]interface{}, error) {
...
func (o *ProductProductDescriptionInner) UnmarshalJSON(data []byte) (err error) {
	...
	varProductProductDescriptionInner := _ProductProductDescriptionInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varProductProductDescriptionInner)

	if err != nil {
		return err
	}

	*o = ProductProductDescriptionInner(varProductProductDescriptionInner)

	return err
}

type NullableProductProductDescriptionInner struct {
	value *ProductProductDescriptionInner
	isSet bool
}

func (v NullableProductProductDescriptionInner) Get() *ProductProductDescriptionInner {
	return v.value
}

func (v *NullableProductProductDescriptionInner) Set(val *ProductProductDescriptionInner) {
	v.value = val
	v.isSet = true
}

func (v NullableProductProductDescriptionInner) IsSet() bool {
	return v.isSet
}

func (v *NullableProductProductDescriptionInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductProductDescriptionInner(val *ProductProductDescriptionInner) *NullableProductProductDescriptionInner {
	return &NullableProductProductDescriptionInner{value: val, isSet: true}
}

func (v NullableProductProductDescriptionInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductProductDescriptionInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
