...
// checks if the ForceCallbackRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ForceCallbackRequest{}

// ForceCallbackRequest Force callback request
type ForceCallbackRequest struct {
...
type _ForceCallbackRequest ForceCallbackRequest
...
func (o ForceCallbackRequest) MarshalJSON() ([]byte, error) {
...
func (o ForceCallbackRequest) ToMap() (map[string]interface{}, error) {
...
func (o *ForceCallbackRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varForceCallbackRequest := _ForceCallbackRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varForceCallbackRequest)

	if err != nil {
		return err
	}

	*o = ForceCallbackRequest(varForceCallbackRequest)

	return err
}

type NullableForceCallbackRequest struct {
	value *ForceCallbackRequest
	isSet bool
}

func (v NullableForceCallbackRequest) Get() *ForceCallbackRequest {
	return v.value
}

func (v *NullableForceCallbackRequest) Set(val *ForceCallbackRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableForceCallbackRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableForceCallbackRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableForceCallbackRequest(val *ForceCallbackRequest) *NullableForceCallbackRequest {
	return &NullableForceCallbackRequest{value: val, isSet: true}
}

func (v NullableForceCallbackRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableForceCallbackRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
