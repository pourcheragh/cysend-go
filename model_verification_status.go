...
// checks if the VerificationStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VerificationStatus{}

// VerificationStatus Verification status
type VerificationStatus struct {
	// Verification request unique code
...
type _VerificationStatus VerificationStatus
...
func (o VerificationStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VerificationStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varVerificationStatus := _VerificationStatus{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVerificationStatus)

	if err != nil {
		return err
	}

	*o = VerificationStatus(varVerificationStatus)
