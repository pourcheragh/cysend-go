...
// checks if the TokenOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TokenOptions{}

// TokenOptions Token creation options
type TokenOptions struct {
	// If set to true, only IPs specified in 'authorized_ips' parameter will be allowed to use this token.
	IpRestricted bool `json:"ip_restricted"`
	// Coma separated list of IPv4 addresses that will be authorized to use this token. The variable 'mine' can be used to authorized the IP that requested the token.
	AuthorizedIps *string `json:"authorized_ips,omitempty"`
	// Token life in seconds. By default 3600 seconds (1 hour).
	TTL *int32 `json:"TTL,omitempty"`
}

type _TokenOptions TokenOptions
...
// GetIpRestricted returns the IpRestricted field value
func (o *TokenOptions) GetIpRestricted() bool {
	...
	return o.IpRestricted
}

// GetIpRestrictedOk returns a tuple with the IpRestricted field value
// and a boolean to check if the value has been set.
func (o *TokenOptions) GetIpRestrictedOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.IpRestricted, true
}

// SetIpRestricted sets field value
func (o *TokenOptions) SetIpRestricted(v bool) {
	o.IpRestricted = v
}

// GetAuthorizedIps returns the AuthorizedIps field value if set, zero value otherwise.
func (o *TokenOptions) GetAuthorizedIps() string {
	if o == nil || IsNil(o.AuthorizedIps) {
		var ret string
		return ret
	}
	return *o.AuthorizedIps
}

// GetAuthorizedIpsOk returns a tuple with the AuthorizedIps field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TokenOptions) GetAuthorizedIpsOk() (*string, bool) {
	if o == nil || IsNil(o.AuthorizedIps) {
		return nil, false
	}
	return o.AuthorizedIps, true
}
...
// SetAuthorizedIps gets a reference to the given string and assigns it to the AuthorizedIps field.
...
func (o TokenOptions) MarshalJSON() ([]byte, error) {
...
func (o TokenOptions) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["ip_restricted"] = o.IpRestricted
	if !IsNil(o.AuthorizedIps) {
		toSerialize["authorized_ips"] = o.AuthorizedIps
	}
	if !IsNil(o.TTL) {
...
func (o *TokenOptions) UnmarshalJSON(data []byte) (err error) {
	...
	varTokenOptions := _TokenOptions{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTokenOptions)

	if err != nil {
		return err
	}

	*o = TokenOptions(varTokenOptions)

	return err
}

type NullableTokenOptions struct {
	value *TokenOptions
	isSet bool
}

func (v NullableTokenOptions) Get() *TokenOptions {
	return v.value
}

func (v *NullableTokenOptions) Set(val *TokenOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableTokenOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableTokenOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTokenOptions(val *TokenOptions) *NullableTokenOptions {
	return &NullableTokenOptions{value: val, isSet: true}
}

func (v NullableTokenOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTokenOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
