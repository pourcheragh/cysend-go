...
func (r ApiCreateAccessTokenRequest) TokenOptions(tokenOptions TokenOptions) ApiCreateAccessTokenRequest {
	r.tokenOptions = &tokenOptions
	return r
}

func (r ApiCreateAccessTokenRequest) Execute() (*Token, *http.Response, error) {
...
*/
func (a *AccessAPIService) CreateAccessToken(ctx context.Context) ApiCreateAccessTokenRequest {
	return ApiCreateAccessTokenRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return Token
func (a *AccessAPIService) CreateAccessTokenExecute(r ApiCreateAccessTokenRequest) (*Token, *http.Response, error) {
	var (
	...
	if r.tokenOptions == nil {
		return localVarReturnValue, nil, reportError("tokenOptions is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.tokenOptions
...
func (r ApiGetAccessTokenRequest) Execute() (*Token, *http.Response, error) {
	return r.ApiService.GetAccessTokenExecute(r)
}

/*
GetAccessToken Retrieves an existing access token

This operation returns the access token information.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetAccessTokenRequest
*/
func (a *AccessAPIService) GetAccessToken(ctx context.Context) ApiGetAccessTokenRequest {
	return ApiGetAccessTokenRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return Token
func (a *AccessAPIService) GetAccessTokenExecute(r ApiGetAccessTokenRequest) (*Token, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccessAPIService.GetAccessToken")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
