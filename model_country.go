...
type Country struct {
	...
	CountryIsoAlpha3 string `json:"country_iso_alpha3"`
...
// GetCountryIsoAlpha2 returns the CountryIsoAlpha2 field value
...
// GetCountryIsoAlpha2Ok returns a tuple with the CountryIsoAlpha2 field value
// and a boolean to check if the value has been set.
...
// SetCountryIsoAlpha2 sets field value
func (o *Country) SetCountryIsoAlpha2(v string) {
	o.CountryIsoAlpha2 = v
}

// GetCountryIsoAlpha3 returns the CountryIsoAlpha3 field value
func (o *Country) GetCountryIsoAlpha3() string {
	...
	return o.CountryIsoAlpha3
}

// GetCountryIsoAlpha3Ok returns a tuple with the CountryIsoAlpha3 field value
// and a boolean to check if the value has been set.
func (o *Country) GetCountryIsoAlpha3Ok() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.CountryIsoAlpha3, true
}

// SetCountryIsoAlpha3 sets field value
func (o *Country) SetCountryIsoAlpha3(v string) {
	o.CountryIsoAlpha3 = v
}
...
func (o Country) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["country_iso_alpha3"] = o.CountryIsoAlpha3
