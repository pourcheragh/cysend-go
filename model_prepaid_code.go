...
// checks if the PrepaidCode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrepaidCode{}

// PrepaidCode Prepaid code product information
type PrepaidCode struct {
	// Prepaid code
	Code string `json:"code"`
	// Prepaid code serial number
	Serial string `json:"serial"`
	// Security code
	PinCode *string `json:"pin_code,omitempty"`
	// Prepaid code expiry date and time in ISO8601 format
	Expiration string `json:"expiration"`
	// Link to PDF file with pin and barcode
...
// GetPdfLink returns the PdfLink field value if set, zero value otherwise.
func (o *PrepaidCode) GetPdfLink() string {
	if o == nil || IsNil(o.PdfLink) {
		var ret string
		return ret
	}
	return *o.PdfLink
...
// GetPdfLinkOk returns a tuple with the PdfLink field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PrepaidCode) GetPdfLinkOk() (*string, bool) {
	if o == nil || IsNil(o.PdfLink) {
		return nil, false
	}
	return o.PdfLink, true
}
...
// SetPdfLink gets a reference to the given string and assigns it to the PdfLink field.
...
func (o PrepaidCode) MarshalJSON() ([]byte, error) {
...
func (o PrepaidCode) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PdfLink) {
		toSerialize["pdf_link"] = o.PdfLink
	}
...
func (o *PrepaidCode) UnmarshalJSON(data []byte) (err error) {
	...
	varPrepaidCode := _PrepaidCode{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPrepaidCode)

	if err != nil {
		return err
	}

	*o = PrepaidCode(varPrepaidCode)

	return err
}

type NullablePrepaidCode struct {
	value *PrepaidCode
	isSet bool
}

func (v NullablePrepaidCode) Get() *PrepaidCode {
	return v.value
}

func (v *NullablePrepaidCode) Set(val *PrepaidCode) {
	v.value = val
	v.isSet = true
}

func (v NullablePrepaidCode) IsSet() bool {
	return v.isSet
}

func (v *NullablePrepaidCode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrepaidCode(val *PrepaidCode) *NullablePrepaidCode {
	return &NullablePrepaidCode{value: val, isSet: true}
}

func (v NullablePrepaidCode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrepaidCode) UnmarshalJSON(src []byte) error {
	v.isSet = true
