...
type Product struct {
	// Indication of the geographical zone in which the product can be used. Countries in a zone might vary depending on product.
	CountryZone string `json:"country_zone"`
	// List of country IDs. A product can be in multiple countries.
	Countries []int32 `json:"countries"`
	// List of category IDs. A product can be in multiple categories.
	Categories []int32 `json:"categories"`
	// Unique product ID
	ProductId int32 `json:"product_id"`
	// Product name
	ProductName string `json:"product_name"`
	// List of prepaid product description in various languages
	ProductDescription []ProductProductDescriptionInner `json:"product_description"`
	// URL to the product logo
	LogoUrl string `json:"logo_url"`
	Type ProductType `json:"type"`
	// True if there is a running promotion
	Promotion bool `json:"promotion"`
	// True if the product is under maintenance
	Maintenance bool `json:"maintenance"`
	// Each product has a different list or required beneficiary information to place a purchase order. Some will require beneficiary mobile number, account number, and others won’t require anything.
	BeneficiaryInformation []ProductParameter `json:"beneficiary_information"`
	// List of available face values
	FaceValueIds []int32 `json:"face_value_ids"`
	// List of prepaid code usage instructions in various languages
	UsageInstructions []ProductUsageInstructionsInner `json:"usage_instructions,omitempty"`
}
...
// GetCountryZone returns the CountryZone field value
func (o *Product) GetCountryZone() string {
	...
	return o.CountryZone
}

// GetCountryZoneOk returns a tuple with the CountryZone field value
// and a boolean to check if the value has been set.
func (o *Product) GetCountryZoneOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.CountryZone, true
}

// SetCountryZone sets field value
...
func (o *Product) GetProductDescription() []ProductProductDescriptionInner {
	if o == nil {
		var ret []ProductProductDescriptionInner
		return ret
	}
...
// GetFaceValueIds returns the FaceValueIds field value
func (o *Product) GetFaceValueIds() []int32 {
	...
	return o.FaceValueIds
}

// GetFaceValueIdsOk returns a tuple with the FaceValueIds field value
// and a boolean to check if the value has been set.
func (o *Product) GetFaceValueIdsOk() ([]int32, bool) {
	if o == nil {
		return nil, false
	}
	return o.FaceValueIds, true
}

// SetFaceValueIds sets field value
func (o *Product) SetFaceValueIds(v []int32) {
	o.FaceValueIds = v
}

// GetUsageInstructions returns the UsageInstructions field value if set, zero value otherwise.
func (o *Product) GetUsageInstructions() []ProductUsageInstructionsInner {
	if o == nil || IsNil(o.UsageInstructions) {
		var ret []ProductUsageInstructionsInner
		return ret
	}
	return o.UsageInstructions
}

// GetUsageInstructionsOk returns a tuple with the UsageInstructions field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetUsageInstructions gets a reference to the given []ProductUsageInstructionsInner and assigns it to the UsageInstructions field.
...
func (o Product) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["country_zone"] = o.CountryZone
	...
	toSerialize["face_value_ids"] = o.FaceValueIds
	if !IsNil(o.UsageInstructions) {
		toSerialize["usage_instructions"] = o.UsageInstructions
	}
