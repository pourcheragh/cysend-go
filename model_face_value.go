...
// checks if the FaceValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FaceValue{}

// FaceValue Face value types
type FaceValue struct {
	Fixed []FixedFaceValue `json:"fixed"`
	Range []RangeFaceValue `json:"range"`
}

type _FaceValue FaceValue
...
func (o FaceValue) MarshalJSON() ([]byte, error) {
...
func (o FaceValue) ToMap() (map[string]interface{}, error) {
...
func (o *FaceValue) UnmarshalJSON(data []byte) (err error) {
	...
	varFaceValue := _FaceValue{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFaceValue)

	if err != nil {
		return err
	}

	*o = FaceValue(varFaceValue)

	return err
}

type NullableFaceValue struct {
	value *FaceValue
	isSet bool
}

func (v NullableFaceValue) Get() *FaceValue {
	return v.value
}

func (v *NullableFaceValue) Set(val *FaceValue) {
	v.value = val
	v.isSet = true
}

func (v NullableFaceValue) IsSet() bool {
	return v.isSet
}

func (v *NullableFaceValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFaceValue(val *FaceValue) *NullableFaceValue {
	return &NullableFaceValue{value: val, isSet: true}
}

func (v NullableFaceValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFaceValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
