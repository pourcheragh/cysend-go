...
// checks if the NotificationResourceType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationResourceType{}

// NotificationResourceType Notification resource type information
type NotificationResourceType struct {
	// Type unique ID
	Uid string `json:"uid"`
	// Type name
...
type _NotificationResourceType NotificationResourceType
...
func (o NotificationResourceType) MarshalJSON() ([]byte, error) {
...
func (o NotificationResourceType) ToMap() (map[string]interface{}, error) {
...
func (o *NotificationResourceType) UnmarshalJSON(data []byte) (err error) {
	...
	varNotificationResourceType := _NotificationResourceType{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNotificationResourceType)

	if err != nil {
		return err
	}

	*o = NotificationResourceType(varNotificationResourceType)

	return err
}

type NullableNotificationResourceType struct {
	value *NotificationResourceType
	isSet bool
}

func (v NullableNotificationResourceType) Get() *NotificationResourceType {
	return v.value
}

func (v *NullableNotificationResourceType) Set(val *NotificationResourceType) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationResourceType) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationResourceType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationResourceType(val *NotificationResourceType) *NullableNotificationResourceType {
	return &NullableNotificationResourceType{value: val, isSet: true}
}

func (v NullableNotificationResourceType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationResourceType) UnmarshalJSON(src []byte) error {
	v.isSet = true
