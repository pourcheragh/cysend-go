...
type Token struct {
	...
	// Expiry date and time in ISO8601 format
	TTL *string `json:"TTL,omitempty"`
	// Coma separated list of authorized IPs
	AuthorizedIps *string `json:"authorized_ips,omitempty"`
	// Token permission list. The default permissions are identical as the API credentials used to create this token.
