...
// checks if the NotificationDestinationParameter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationDestinationParameter{}

// NotificationDestinationParameter Notification destination parameter
type NotificationDestinationParameter struct {
	// Parameter name
...
type _NotificationDestinationParameter NotificationDestinationParameter
...
func NewNotificationDestinationParameter(name string, value string) *NotificationDestinationParameter {
	this := NotificationDestinationParameter{}
	this.Name = name
	this.Value = value
	return &this
}
...
func (o NotificationDestinationParameter) MarshalJSON() ([]byte, error) {
...
func (o NotificationDestinationParameter) ToMap() (map[string]interface{}, error) {
...
func (o *NotificationDestinationParameter) UnmarshalJSON(data []byte) (err error) {
	...
	varNotificationDestinationParameter := _NotificationDestinationParameter{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNotificationDestinationParameter)

	if err != nil {
		return err
	}

	*o = NotificationDestinationParameter(varNotificationDestinationParameter)

	return err
}

type NullableNotificationDestinationParameter struct {
	value *NotificationDestinationParameter
	isSet bool
}

func (v NullableNotificationDestinationParameter) Get() *NotificationDestinationParameter {
	return v.value
}

func (v *NullableNotificationDestinationParameter) Set(val *NotificationDestinationParameter) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationDestinationParameter) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationDestinationParameter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationDestinationParameter(val *NotificationDestinationParameter) *NullableNotificationDestinationParameter {
	return &NullableNotificationDestinationParameter{value: val, isSet: true}
}

func (v NullableNotificationDestinationParameter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationDestinationParameter) UnmarshalJSON(src []byte) error {
	v.isSet = true
