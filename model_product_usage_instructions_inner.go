...
// checks if the ProductUsageInstructionsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductUsageInstructionsInner{}

// ProductUsageInstructionsInner A prepaid code usage instruction in a specific language
type ProductUsageInstructionsInner struct {
...
type _ProductUsageInstructionsInner ProductUsageInstructionsInner
...
func NewProductUsageInstructionsInner(language string, text string) *ProductUsageInstructionsInner {
	this := ProductUsageInstructionsInner{}
...
func (o ProductUsageInstructionsInner) MarshalJSON() ([]byte, error) {
...
func (o ProductUsageInstructionsInner) ToMap() (map[string]interface{}, error) {
...
func (o *ProductUsageInstructionsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varProductUsageInstructionsInner := _ProductUsageInstructionsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varProductUsageInstructionsInner)

	if err != nil {
		return err
	}

	*o = ProductUsageInstructionsInner(varProductUsageInstructionsInner)

	return err
}

type NullableProductUsageInstructionsInner struct {
	value *ProductUsageInstructionsInner
	isSet bool
}

func (v NullableProductUsageInstructionsInner) Get() *ProductUsageInstructionsInner {
	return v.value
}

func (v *NullableProductUsageInstructionsInner) Set(val *ProductUsageInstructionsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableProductUsageInstructionsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableProductUsageInstructionsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductUsageInstructionsInner(val *ProductUsageInstructionsInner) *NullableProductUsageInstructionsInner {
	return &NullableProductUsageInstructionsInner{value: val, isSet: true}
}

func (v NullableProductUsageInstructionsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductUsageInstructionsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
