...
// ProductType Instant: means that the top up will credited directly to the customer account Prepaid code: means that the top up will be delivered as a prepaid code with usage instructions. The customer will have to follow the instructions to use his prepaid code. SMS: means that the product is a text message. HLR: means that the product is a mobile operator detection.
type ProductType string

// List of ProductType
const (
	PRODUCTTYPE_INSTANT ProductType = "instant"
	PRODUCTTYPE_PREPAID_CODE ProductType = "prepaid_code"
	PRODUCTTYPE_SMS ProductType = "sms"
	PRODUCTTYPE_HLR ProductType = "hlr"
)
