...
// checks if the ProductParameterElementsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductParameterElementsInner{}

// ProductParameterElementsInner Selectbox element
type ProductParameterElementsInner struct {
	// Value that must be sent during purchase
	Value *string `json:"value,omitempty"`
	// Information that must be shown to the CUSTOMER'S customer.
...
func NewProductParameterElementsInner() *ProductParameterElementsInner {
	this := ProductParameterElementsInner{}
	return &this
}
...
func (o ProductParameterElementsInner) MarshalJSON() ([]byte, error) {
...
func (o ProductParameterElementsInner) ToMap() (map[string]interface{}, error) {
...
type NullableProductParameterElementsInner struct {
	value *ProductParameterElementsInner
	isSet bool
}

func (v NullableProductParameterElementsInner) Get() *ProductParameterElementsInner {
	return v.value
}

func (v *NullableProductParameterElementsInner) Set(val *ProductParameterElementsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableProductParameterElementsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableProductParameterElementsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductParameterElementsInner(val *ProductParameterElementsInner) *NullableProductParameterElementsInner {
	return &NullableProductParameterElementsInner{value: val, isSet: true}
}

func (v NullableProductParameterElementsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductParameterElementsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
