...
var _ MappedNullable = &FixedFaceValue{}

// FixedFaceValue Fixed face value information
type FixedFaceValue struct {
	// Product ID
...
type _FixedFaceValue FixedFaceValue
...
func (o FixedFaceValue) MarshalJSON() ([]byte, error) {
...
func (o FixedFaceValue) ToMap() (map[string]interface{}, error) {
...
func (o *FixedFaceValue) UnmarshalJSON(data []byte) (err error) {
	...
	varFixedFaceValue := _FixedFaceValue{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFixedFaceValue)

	if err != nil {
		return err
	}

	*o = FixedFaceValue(varFixedFaceValue)

	return err
}

type NullableFixedFaceValue struct {
	value *FixedFaceValue
	isSet bool
}

func (v NullableFixedFaceValue) Get() *FixedFaceValue {
	return v.value
}

func (v *NullableFixedFaceValue) Set(val *FixedFaceValue) {
	v.value = val
	v.isSet = true
}

func (v NullableFixedFaceValue) IsSet() bool {
	return v.isSet
}

func (v *NullableFixedFaceValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFixedFaceValue(val *FixedFaceValue) *NullableFixedFaceValue {
	return &NullableFixedFaceValue{value: val, isSet: true}
}

func (v NullableFixedFaceValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFixedFaceValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
