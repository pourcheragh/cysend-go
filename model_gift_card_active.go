...
// checks if the GiftCardActive type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GiftCardActive{}

// GiftCardActive Gift card active
type GiftCardActive struct {
	// Flag to see if gift card is active or not
	Active bool `json:"active"`
}

type _GiftCardActive GiftCardActive
...
func (o GiftCardActive) MarshalJSON() ([]byte, error) {
...
func (o GiftCardActive) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["active"] = o.Active
	return toSerialize, nil
}

func (o *GiftCardActive) UnmarshalJSON(data []byte) (err error) {
	...
	varGiftCardActive := _GiftCardActive{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGiftCardActive)

	if err != nil {
		return err
	}

	*o = GiftCardActive(varGiftCardActive)

	return err
}

type NullableGiftCardActive struct {
	value *GiftCardActive
	isSet bool
}

func (v NullableGiftCardActive) Get() *GiftCardActive {
	return v.value
}

func (v *NullableGiftCardActive) Set(val *GiftCardActive) {
	v.value = val
	v.isSet = true
}

func (v NullableGiftCardActive) IsSet() bool {
	return v.isSet
}

func (v *NullableGiftCardActive) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGiftCardActive(val *GiftCardActive) *NullableGiftCardActive {
	return &NullableGiftCardActive{value: val, isSet: true}
}

func (v NullableGiftCardActive) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGiftCardActive) UnmarshalJSON(src []byte) error {
	v.isSet = true
