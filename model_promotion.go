...
type Promotion struct {
	...
	// Date and time of promotion start in ISO8601 format
	StartTime string `json:"start_time"`
	// Date and time of promotion start in ISO8601 format
	StopTime string `json:"stop_time"`
	TimeZone PromotionTimeZone `json:"time_zone"`
	// List of promotion descriptions in various languages
	Descriptions []PromotionDescriptionsInner `json:"descriptions"`
	// List of face values included in the promotion
	FaceValueIds []int32 `json:"face_value_ids,omitempty"`
}
...
func (o *Promotion) GetDescriptions() []PromotionDescriptionsInner {
	if o == nil {
		var ret []PromotionDescriptionsInner
		return ret
	}
...
// GetFaceValueIds returns the FaceValueIds field value if set, zero value otherwise.
func (o *Promotion) GetFaceValueIds() []int32 {
	if o == nil || IsNil(o.FaceValueIds) {
		var ret []int32
		return ret
	}
...
// GetFaceValueIdsOk returns a tuple with the FaceValueIds field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetFaceValueIds gets a reference to the given []int32 and assigns it to the FaceValueIds field.
