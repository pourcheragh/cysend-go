...
func (r ApiGetNotificationChannelsRequest) Execute() ([]NotificationChannel, *http.Response, error) {
	return r.ApiService.GetNotificationChannelsExecute(r)
}

/*
GetNotificationChannels Retrieve the list of notification channels

This operation retrieves the list of channels.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetNotificationChannelsRequest
*/
func (a *NotificationsAPIService) GetNotificationChannels(ctx context.Context) ApiGetNotificationChannelsRequest {
	return ApiGetNotificationChannelsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *NotificationsAPIService) GetNotificationChannelsExecute(r ApiGetNotificationChannelsRequest) ([]NotificationChannel, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NotificationsAPIService.GetNotificationChannels")
	if err != nil {
...
type ApiGetNotificationEventsRequest struct {
	ctx context.Context
	ApiService *NotificationsAPIService
}

func (r ApiGetNotificationEventsRequest) Execute() ([]NotificationEvent, *http.Response, error) {
	return r.ApiService.GetNotificationEventsExecute(r)
}

/*
GetNotificationEvents Retrieve the list of notification events

This operation retrieves the list of events.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetNotificationEventsRequest
*/
func (a *NotificationsAPIService) GetNotificationEvents(ctx context.Context) ApiGetNotificationEventsRequest {
	return ApiGetNotificationEventsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *NotificationsAPIService) GetNotificationEventsExecute(r ApiGetNotificationEventsRequest) ([]NotificationEvent, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NotificationsAPIService.GetNotificationEvents")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/notification/events"
...
type ApiGetNotificationResourceTypesRequest struct {
	ctx context.Context
	ApiService *NotificationsAPIService
}

func (r ApiGetNotificationResourceTypesRequest) Execute() ([]NotificationResourceType, *http.Response, error) {
	return r.ApiService.GetNotificationResourceTypesExecute(r)
}

/*
GetNotificationResourceTypes Retrieve the list of notification resource types

This operation retrieves the notification resource types.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetNotificationResourceTypesRequest
*/
func (a *NotificationsAPIService) GetNotificationResourceTypes(ctx context.Context) ApiGetNotificationResourceTypesRequest {
	return ApiGetNotificationResourceTypesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *NotificationsAPIService) GetNotificationResourceTypesExecute(r ApiGetNotificationResourceTypesRequest) ([]NotificationResourceType, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []NotificationResourceType
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NotificationsAPIService.GetNotificationResourceTypes")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/notification/resource_types"
