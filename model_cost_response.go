...
// checks if the CostResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CostResponse{}
...
type _CostResponse CostResponse
...
func (o CostResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CostResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCostResponse := _CostResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCostResponse)

	if err != nil {
		return err
	}

	*o = CostResponse(varCostResponse)
