...
type NotificationEvent struct {
	// Unique ID
	Uid string `json:"uid"`
	// Notification resource type unique ID
	ResourceTypeUid string `json:"resource_type_uid"`
	// Event name
...
func NewNotificationEvent(uid string, resourceTypeUid string, name string) *NotificationEvent {
	...
	this.Uid = uid
	this.ResourceTypeUid = resourceTypeUid
	this.Name = name
	return &this
}
...
// GetResourceTypeUid returns the ResourceTypeUid field value
func (o *NotificationEvent) GetResourceTypeUid() string {
	...
	return o.ResourceTypeUid
}

// GetResourceTypeUidOk returns a tuple with the ResourceTypeUid field value
// and a boolean to check if the value has been set.
func (o *NotificationEvent) GetResourceTypeUidOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ResourceTypeUid, true
}

// SetResourceTypeUid sets field value
...
func (o NotificationEvent) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["resource_type_uid"] = o.ResourceTypeUid
