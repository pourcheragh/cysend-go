...
func (r ApiBalanceRequest) Execute() (*CustomerBalance, *http.Response, error) {
	return r.ApiService.BalanceExecute(r)
}

/*
Balance Retrieves customer account default balance
...
*/
func (a *CustomerAPIService) Balance(ctx context.Context) ApiBalanceRequest {
	return ApiBalanceRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *CustomerAPIService) BalanceExecute(r ApiBalanceRequest) (*CustomerBalance, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomerAPIService.Balance")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/customer/balance"
...
/*
GetSubscriptions Retrieves the list of subscriptions

This operation returns the CUSTOMER notifications subscriptions.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetSubscriptionsRequest
*/
func (a *CustomerAPIService) GetSubscriptions(ctx context.Context) ApiGetSubscriptionsRequest {
	return ApiGetSubscriptionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []Subscription
func (a *CustomerAPIService) GetSubscriptionsExecute(r ApiGetSubscriptionsRequest) ([]Subscription, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CustomerAPIService.GetSubscriptions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/customer/subscriptions"
