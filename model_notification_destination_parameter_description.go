...
// checks if the NotificationDestinationParameterDescription type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationDestinationParameterDescription{}

// NotificationDestinationParameterDescription Notification destination parameter
type NotificationDestinationParameterDescription struct {
	// Name
	Name string `json:"name"`
	// If true means that the destination parameter is mandatory.
	Required bool `json:"required"`
}

type _NotificationDestinationParameterDescription NotificationDestinationParameterDescription
...
func NewNotificationDestinationParameterDescription(name string, required bool) *NotificationDestinationParameterDescription {
	this := NotificationDestinationParameterDescription{}
	this.Name = name
...
func (o NotificationDestinationParameterDescription) MarshalJSON() ([]byte, error) {
...
func (o NotificationDestinationParameterDescription) ToMap() (map[string]interface{}, error) {
...
func (o *NotificationDestinationParameterDescription) UnmarshalJSON(data []byte) (err error) {
	...
	varNotificationDestinationParameterDescription := _NotificationDestinationParameterDescription{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNotificationDestinationParameterDescription)

	if err != nil {
		return err
	}

	*o = NotificationDestinationParameterDescription(varNotificationDestinationParameterDescription)

	return err
}

type NullableNotificationDestinationParameterDescription struct {
	value *NotificationDestinationParameterDescription
	isSet bool
}

func (v NullableNotificationDestinationParameterDescription) Get() *NotificationDestinationParameterDescription {
	return v.value
}

func (v *NullableNotificationDestinationParameterDescription) Set(val *NotificationDestinationParameterDescription) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationDestinationParameterDescription) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationDestinationParameterDescription) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationDestinationParameterDescription(val *NotificationDestinationParameterDescription) *NullableNotificationDestinationParameterDescription {
	return &NullableNotificationDestinationParameterDescription{value: val, isSet: true}
}

func (v NullableNotificationDestinationParameterDescription) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationDestinationParameterDescription) UnmarshalJSON(src []byte) error {
	v.isSet = true
