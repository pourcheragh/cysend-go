...
func (r ApiGetErrorsRequest) Execute() ([]APIErrorDescription, *http.Response, error) {
	return r.ApiService.GetErrorsExecute(r)
}

/*
GetErrors Retrieves the list of CY.SEND OpenAPI errors

This operation retrieves the list of CY.SEND OpenAPI errors.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetErrorsRequest
*/
func (a *OpenAPIAPIService) GetErrors(ctx context.Context) ApiGetErrorsRequest {
	return ApiGetErrorsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *OpenAPIAPIService) GetErrorsExecute(r ApiGetErrorsRequest) ([]APIErrorDescription, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OpenAPIAPIService.GetErrors")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/openapi/errors"
...
/*
Ping CY.SEND OpenAPI connection status monitor

This operation is to monitor your connection to CY.SEND OpenAPI.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPingRequest
*/
func (a *OpenAPIAPIService) Ping(ctx context.Context) ApiPingRequest {
	return ApiPingRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return string
func (a *OpenAPIAPIService) PingExecute(r ApiPingRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OpenAPIAPIService.Ping")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/openapi/ping"
