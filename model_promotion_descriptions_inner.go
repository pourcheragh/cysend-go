...
// checks if the PromotionDescriptionsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PromotionDescriptionsInner{}

// PromotionDescriptionsInner Promotion description in a specific language
type PromotionDescriptionsInner struct {
	...
	// Promotion denominations explanation
	Denominations string `json:"denominations"`
}

type _PromotionDescriptionsInner PromotionDescriptionsInner
...
func NewPromotionDescriptionsInner(language string, title string, conditionsSummary string, conditions string, denominations string) *PromotionDescriptionsInner {
	this := PromotionDescriptionsInner{}
...
// GetConditionsSummary returns the ConditionsSummary field value
func (o *PromotionDescriptionsInner) GetConditionsSummary() string {
	...
	return o.ConditionsSummary
}

// GetConditionsSummaryOk returns a tuple with the ConditionsSummary field value
// and a boolean to check if the value has been set.
func (o *PromotionDescriptionsInner) GetConditionsSummaryOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ConditionsSummary, true
}

// SetConditionsSummary sets field value
func (o *PromotionDescriptionsInner) SetConditionsSummary(v string) {
	o.ConditionsSummary = v
}
...
// GetDenominations returns the Denominations field value
func (o *PromotionDescriptionsInner) GetDenominations() string {
	...
	return o.Denominations
}

// GetDenominationsOk returns a tuple with the Denominations field value
// and a boolean to check if the value has been set.
func (o *PromotionDescriptionsInner) GetDenominationsOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Denominations, true
}

// SetDenominations sets field value
func (o *PromotionDescriptionsInner) SetDenominations(v string) {
	o.Denominations = v
}

func (o PromotionDescriptionsInner) MarshalJSON() ([]byte, error) {
...
func (o PromotionDescriptionsInner) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["language"] = o.Language
	toSerialize["title"] = o.Title
	toSerialize["conditions_summary"] = o.ConditionsSummary
	toSerialize["conditions"] = o.Conditions
	toSerialize["denominations"] = o.Denominations
	return toSerialize, nil
}

func (o *PromotionDescriptionsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varPromotionDescriptionsInner := _PromotionDescriptionsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPromotionDescriptionsInner)

	if err != nil {
		return err
	}

	*o = PromotionDescriptionsInner(varPromotionDescriptionsInner)

	return err
}

type NullablePromotionDescriptionsInner struct {
	value *PromotionDescriptionsInner
	isSet bool
}

func (v NullablePromotionDescriptionsInner) Get() *PromotionDescriptionsInner {
	return v.value
}

func (v *NullablePromotionDescriptionsInner) Set(val *PromotionDescriptionsInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePromotionDescriptionsInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePromotionDescriptionsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePromotionDescriptionsInner(val *PromotionDescriptionsInner) *NullablePromotionDescriptionsInner {
	return &NullablePromotionDescriptionsInner{value: val, isSet: true}
}

func (v NullablePromotionDescriptionsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePromotionDescriptionsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
