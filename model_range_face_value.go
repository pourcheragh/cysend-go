...
var _ MappedNullable = &RangeFaceValue{}

// RangeFaceValue Range face value information
type RangeFaceValue struct {
	// Product ID
...
type _RangeFaceValue RangeFaceValue
...
// GetCostCurrency returns the CostCurrency field value
...
// GetCostCurrencyOk returns a tuple with the CostCurrency field value
// and a boolean to check if the value has been set.
func (o *RangeFaceValue) GetCostCurrencyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.CostCurrency, true
}

// SetCostCurrency sets field value
...
func (o RangeFaceValue) MarshalJSON() ([]byte, error) {
...
func (o RangeFaceValue) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["product_id"] = o.ProductId
	toSerialize["face_value_id"] = o.FaceValueId
	toSerialize["face_value_from"] = o.FaceValueFrom
	toSerialize["face_value_to"] = o.FaceValueTo
	toSerialize["face_value_step"] = o.FaceValueStep
	toSerialize["face_value_currency"] = o.FaceValueCurrency
	toSerialize["minimum_cost"] = o.MinimumCost
	toSerialize["maximum_cost"] = o.MaximumCost
	toSerialize["cost_currency"] = o.CostCurrency
	toSerialize["promotion"] = o.Promotion
	return toSerialize, nil
}

func (o *RangeFaceValue) UnmarshalJSON(data []byte) (err error) {
	...
	varRangeFaceValue := _RangeFaceValue{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRangeFaceValue)

	if err != nil {
		return err
	}

	*o = RangeFaceValue(varRangeFaceValue)

	return err
}

type NullableRangeFaceValue struct {
	value *RangeFaceValue
	isSet bool
}

func (v NullableRangeFaceValue) Get() *RangeFaceValue {
	return v.value
}

func (v *NullableRangeFaceValue) Set(val *RangeFaceValue) {
	v.value = val
	v.isSet = true
}

func (v NullableRangeFaceValue) IsSet() bool {
	return v.isSet
}

func (v *NullableRangeFaceValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRangeFaceValue(val *RangeFaceValue) *NullableRangeFaceValue {
	return &NullableRangeFaceValue{value: val, isSet: true}
}

func (v NullableRangeFaceValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRangeFaceValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
