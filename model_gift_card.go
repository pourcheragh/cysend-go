...
type GiftCard struct {
	...
	// CY.SEND gift card serial number
	Serial string `json:"serial"`
	// CY.SEND gift card name
	Name string `json:"name"`
	// CY.SEND gift card logo URL
...
// GetUsageInstruction returns the UsageInstruction field value
...
// GetUsageInstructionOk returns a tuple with the UsageInstruction field value
// and a boolean to check if the value has been set.
...
// SetUsageInstruction sets field value
...
func (o GiftCard) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["remaining_balance"] = o.RemainingBalance
	toSerialize["expiration"] = o.Expiration
	toSerialize["usage_instruction"] = o.UsageInstruction
	return toSerialize, nil
}

func (o *GiftCard) UnmarshalJSON(data []byte) (err error) {
	...
	varGiftCard := _GiftCard{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGiftCard)

	if err != nil {
		return err
	}

	*o = GiftCard(varGiftCard)
