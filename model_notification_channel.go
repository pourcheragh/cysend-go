...
type NotificationChannel struct {
	...
	// If true means notifications will be send using your templates; If false CY.SEND templates will be used.
	Whitelabel bool `json:"whitelabel"`
	// List of destination parameters
	Destination []NotificationDestinationParameterDescription `json:"destination"`
}
...
// GetWhitelabel returns the Whitelabel field value
...
// GetWhitelabelOk returns a tuple with the Whitelabel field value
// and a boolean to check if the value has been set.
...
// SetWhitelabel sets field value
...
func (o *NotificationChannel) GetDestination() []NotificationDestinationParameterDescription {
	if o == nil {
		var ret []NotificationDestinationParameterDescription
		return ret
	}
