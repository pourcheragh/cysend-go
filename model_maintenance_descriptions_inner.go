...
// checks if the MaintenanceDescriptionsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceDescriptionsInner{}

// MaintenanceDescriptionsInner A maintenance description in a specific language
type MaintenanceDescriptionsInner struct {
...
type _MaintenanceDescriptionsInner MaintenanceDescriptionsInner
...
func NewMaintenanceDescriptionsInner(language string, text string) *MaintenanceDescriptionsInner {
	this := MaintenanceDescriptionsInner{}
...
func (o MaintenanceDescriptionsInner) MarshalJSON() ([]byte, error) {
...
func (o MaintenanceDescriptionsInner) ToMap() (map[string]interface{}, error) {
...
func (o *MaintenanceDescriptionsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varMaintenanceDescriptionsInner := _MaintenanceDescriptionsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMaintenanceDescriptionsInner)

	if err != nil {
		return err
	}

	*o = MaintenanceDescriptionsInner(varMaintenanceDescriptionsInner)

	return err
}

type NullableMaintenanceDescriptionsInner struct {
	value *MaintenanceDescriptionsInner
	isSet bool
}

func (v NullableMaintenanceDescriptionsInner) Get() *MaintenanceDescriptionsInner {
	return v.value
}

func (v *NullableMaintenanceDescriptionsInner) Set(val *MaintenanceDescriptionsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceDescriptionsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenanceDescriptionsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenanceDescriptionsInner(val *MaintenanceDescriptionsInner) *NullableMaintenanceDescriptionsInner {
	return &NullableMaintenanceDescriptionsInner{value: val, isSet: true}
}

func (v NullableMaintenanceDescriptionsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMaintenanceDescriptionsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
