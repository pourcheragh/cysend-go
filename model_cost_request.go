...
// checks if the CostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CostRequest{}
...
func (o CostRequest) MarshalJSON() ([]byte, error) {
...
func (o CostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCostRequest := _CostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCostRequest)

	if err != nil {
		return err
	}

	*o = CostRequest(varCostRequest)

	return err
}

type NullableCostRequest struct {
	value *CostRequest
	isSet bool
}

func (v NullableCostRequest) Get() *CostRequest {
	return v.value
}

func (v *NullableCostRequest) Set(val *CostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCostRequest(val *CostRequest) *NullableCostRequest {
	return &NullableCostRequest{value: val, isSet: true}
}

func (v NullableCostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
