...
// checks if the ProductParameter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductParameter{}
...
type ProductParameter struct {
	...
	// Parameter pattern (only present for type input parameter)
	Pattern *string `json:"pattern,omitempty"`
	// List of select box elements (only present for type select parameter)
	Elements []ProductParameterElementsInner `json:"elements,omitempty"`
	// If true, this parameter is mandatory.
	Required bool `json:"required"`
}

type _ProductParameter ProductParameter
...
func (o *ProductParameter) GetElements() []ProductParameterElementsInner {
	if o == nil || IsNil(o.Elements) {
		var ret []ProductParameterElementsInner
		return ret
	}
	return o.Elements
}
...
// SetElements gets a reference to the given []ProductParameterElementsInner and assigns it to the Elements field.
...
func (o ProductParameter) MarshalJSON() ([]byte, error) {
...
func (o ProductParameter) ToMap() (map[string]interface{}, error) {
...
func (o *ProductParameter) UnmarshalJSON(data []byte) (err error) {
	...
	varProductParameter := _ProductParameter{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varProductParameter)

	if err != nil {
		return err
	}

	*o = ProductParameter(varProductParameter)

	return err
}

type NullableProductParameter struct {
	value *ProductParameter
	isSet bool
}

func (v NullableProductParameter) Get() *ProductParameter {
	return v.value
}

func (v *NullableProductParameter) Set(val *ProductParameter) {
	v.value = val
	v.isSet = true
}

func (v NullableProductParameter) IsSet() bool {
	return v.isSet
}

func (v *NullableProductParameter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductParameter(val *ProductParameter) *NullableProductParameter {
	return &NullableProductParameter{value: val, isSet: true}
}

func (v NullableProductParameter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductParameter) UnmarshalJSON(src []byte) error {
	v.isSet = true
