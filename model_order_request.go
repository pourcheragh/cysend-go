...
type OrderRequest struct {
	// CUSTOMER must assign a unique order ID
	...
	Scenario *OrderScenario `json:"scenario,omitempty"`
	...
	Notifications []Subscription `json:"notifications,omitempty"`
}
...
// SetScenario gets a reference to the given OrderScenario and assigns it to the Scenario field.
...
// SetNotifications gets a reference to the given []Subscription and assigns it to the Notifications field.
