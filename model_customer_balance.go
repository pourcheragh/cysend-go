...
var _ MappedNullable = &CustomerBalance{}
...
type _CustomerBalance CustomerBalance
...
func (o CustomerBalance) MarshalJSON() ([]byte, error) {
...
func (o CustomerBalance) ToMap() (map[string]interface{}, error) {
...
func (o *CustomerBalance) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomerBalance := _CustomerBalance{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCustomerBalance)

	if err != nil {
		return err
	}

	*o = CustomerBalance(varCustomerBalance)

	return err
}

type NullableCustomerBalance struct {
	value *CustomerBalance
	isSet bool
}

func (v NullableCustomerBalance) Get() *CustomerBalance {
	return v.value
}

func (v *NullableCustomerBalance) Set(val *CustomerBalance) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomerBalance) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomerBalance) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomerBalance(val *CustomerBalance) *NullableCustomerBalance {
	return &NullableCustomerBalance{value: val, isSet: true}
}

func (v NullableCustomerBalance) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomerBalance) UnmarshalJSON(src []byte) error {
	v.isSet = true
