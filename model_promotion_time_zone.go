...
// checks if the PromotionTimeZone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PromotionTimeZone{}

// PromotionTimeZone Time zone information
type PromotionTimeZone struct {
	// Time zone name
...
type _PromotionTimeZone PromotionTimeZone
...
func (o PromotionTimeZone) MarshalJSON() ([]byte, error) {
...
func (o PromotionTimeZone) ToMap() (map[string]interface{}, error) {
...
func (o *PromotionTimeZone) UnmarshalJSON(data []byte) (err error) {
	...
	varPromotionTimeZone := _PromotionTimeZone{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPromotionTimeZone)

	if err != nil {
		return err
	}

	*o = PromotionTimeZone(varPromotionTimeZone)

	return err
}

type NullablePromotionTimeZone struct {
	value *PromotionTimeZone
	isSet bool
}

func (v NullablePromotionTimeZone) Get() *PromotionTimeZone {
	return v.value
}

func (v *NullablePromotionTimeZone) Set(val *PromotionTimeZone) {
	v.value = val
	v.isSet = true
}

func (v NullablePromotionTimeZone) IsSet() bool {
	return v.isSet
}

func (v *NullablePromotionTimeZone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePromotionTimeZone(val *PromotionTimeZone) *NullablePromotionTimeZone {
	return &NullablePromotionTimeZone{value: val, isSet: true}
}

func (v NullablePromotionTimeZone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePromotionTimeZone) UnmarshalJSON(src []byte) error {
	v.isSet = true
