...
type OrderStatus struct {
	// CY.SEND order unique ID
	Uid string `json:"uid"`
	// CUSTOMER unique order ID
	UserUid string `json:"user_uid"`
	// Order date and time in ISO8601 format
	...
	Scenario OrderScenario `json:"scenario"`
	...
	BeneficiaryInformation []BeneficiaryInformation `json:"beneficiary_information"`
	// Issuer reference
	IssuerReference *string `json:"issuer_reference,omitempty"`
	PrepaidCode *PrepaidCode `json:"prepaid_code,omitempty"`
	// Order status
	Status string `json:"status"`
	// Response code as per ISO8583
...
func NewOrderStatusWithDefaults() *OrderStatus {
	this := OrderStatus{}
	var scenario OrderScenario = ORDERSCENARIO_LIVE
	this.Scenario = scenario
	return &this
}
...
// GetFaceValueId returns the FaceValueId field value
func (o *OrderStatus) GetFaceValueId() int32 {
	...
	return o.FaceValueId
}

// GetFaceValueIdOk returns a tuple with the FaceValueId field value
// and a boolean to check if the value has been set.
func (o *OrderStatus) GetFaceValueIdOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.FaceValueId, true
}

// SetFaceValueId sets field value
...
// GetFaceValueCurrency returns the FaceValueCurrency field value
func (o *OrderStatus) GetFaceValueCurrency() string {
	...
	return o.FaceValueCurrency
}

// GetFaceValueCurrencyOk returns a tuple with the FaceValueCurrency field value
// and a boolean to check if the value has been set.
func (o *OrderStatus) GetFaceValueCurrencyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.FaceValueCurrency, true
}

// SetFaceValueCurrency sets field value
func (o *OrderStatus) SetFaceValueCurrency(v string) {
	o.FaceValueCurrency = v
}
...
// GetBeneficiaryInformation returns the BeneficiaryInformation field value
func (o *OrderStatus) GetBeneficiaryInformation() []BeneficiaryInformation {
	if o == nil {
		var ret []BeneficiaryInformation
		return ret
	}

	return o.BeneficiaryInformation
}

// GetBeneficiaryInformationOk returns a tuple with the BeneficiaryInformation field value
// and a boolean to check if the value has been set.
func (o *OrderStatus) GetBeneficiaryInformationOk() ([]BeneficiaryInformation, bool) {
	if o == nil {
		return nil, false
	}
	return o.BeneficiaryInformation, true
}

// SetBeneficiaryInformation sets field value
func (o *OrderStatus) SetBeneficiaryInformation(v []BeneficiaryInformation) {
	o.BeneficiaryInformation = v
}

// GetIssuerReference returns the IssuerReference field value if set, zero value otherwise.
func (o *OrderStatus) GetIssuerReference() string {
	if o == nil || IsNil(o.IssuerReference) {
		var ret string
		return ret
	}
	return *o.IssuerReference
}

// GetIssuerReferenceOk returns a tuple with the IssuerReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OrderStatus) GetIssuerReferenceOk() (*string, bool) {
	if o == nil || IsNil(o.IssuerReference) {
		return nil, false
	}
	return o.IssuerReference, true
}
...
// SetIssuerReference gets a reference to the given string and assigns it to the IssuerReference field.
func (o *OrderStatus) SetIssuerReference(v string) {
	o.IssuerReference = &v
}

// GetPrepaidCode returns the PrepaidCode field value if set, zero value otherwise.
func (o *OrderStatus) GetPrepaidCode() PrepaidCode {
	if o == nil || IsNil(o.PrepaidCode) {
		var ret PrepaidCode
		return ret
	}
	return *o.PrepaidCode
}

// GetPrepaidCodeOk returns a tuple with the PrepaidCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OrderStatus) GetPrepaidCodeOk() (*PrepaidCode, bool) {
	if o == nil || IsNil(o.PrepaidCode) {
		return nil, false
	}
	return o.PrepaidCode, true
}
...
// SetPrepaidCode gets a reference to the given PrepaidCode and assigns it to the PrepaidCode field.
...
// GetResponseTitle returns the ResponseTitle field value
func (o *OrderStatus) GetResponseTitle() string {
	...
	return o.ResponseTitle
}

// GetResponseTitleOk returns a tuple with the ResponseTitle field value
// and a boolean to check if the value has been set.
func (o *OrderStatus) GetResponseTitleOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ResponseTitle, true
}

// SetResponseTitle sets field value
func (o *OrderStatus) SetResponseTitle(v string) {
	o.ResponseTitle = v
}

// GetResponseDescription returns the ResponseDescription field value
func (o *OrderStatus) GetResponseDescription() string {
	...
	return o.ResponseDescription
}

// GetResponseDescriptionOk returns a tuple with the ResponseDescription field value
// and a boolean to check if the value has been set.
func (o *OrderStatus) GetResponseDescriptionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ResponseDescription, true
}

// SetResponseDescription sets field value
func (o *OrderStatus) SetResponseDescription(v string) {
	o.ResponseDescription = v
}
...
func (o OrderStatus) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["face_value_id"] = o.FaceValueId
	toSerialize["face_value"] = o.FaceValue
	toSerialize["face_value_currency"] = o.FaceValueCurrency
	if !IsNil(o.GiftCardCode) {
	...
	toSerialize["beneficiary_information"] = o.BeneficiaryInformation
	if !IsNil(o.IssuerReference) {
		toSerialize["issuer_reference"] = o.IssuerReference
	}
	if !IsNil(o.PrepaidCode) {
		toSerialize["prepaid_code"] = o.PrepaidCode
	}
	toSerialize["status"] = o.Status
	toSerialize["response_code"] = o.ResponseCode
	toSerialize["response_title"] = o.ResponseTitle
	toSerialize["response_description"] = o.ResponseDescription
