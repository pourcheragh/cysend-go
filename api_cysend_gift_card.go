...
type CYSENDGiftCardAPIService service

type ApiGetActiveRequest struct {
	ctx context.Context
	ApiService *CYSENDGiftCardAPIService
	giftCardCode string
}

func (r ApiGetActiveRequest) Execute() (*GiftCardActive, *http.Response, error) {
	return r.ApiService.GetActiveExecute(r)
}

/*
GetActive Checks if a CY.SEND gift card is active

This operation returns if the CY.SEND gift card is active.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param giftCardCode CY.SEND gift card PIN code
 @return ApiGetActiveRequest
*/
func (a *CYSENDGiftCardAPIService) GetActive(ctx context.Context, giftCardCode string) ApiGetActiveRequest {
	return ApiGetActiveRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *CYSENDGiftCardAPIService) GetActiveExecute(r ApiGetActiveRequest) (*GiftCardActive, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GiftCardActive
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CYSENDGiftCardAPIService.GetActive")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/gift-card/{gift_card_code}/active"
	localVarPath = strings.Replace(localVarPath, "{"+"gift_card_code"+"}", url.PathEscape(parameterValueToString(r.giftCardCode, "giftCardCode")), -1)
...
/*
GetGiftCard Retrieves a CY.SEND gift card information by PIN code

This operation returns an existing CY.SEND gift card information.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param giftCardCode CY.SEND gift card PIN code
 @return ApiGetGiftCardRequest
*/
func (a *CYSENDGiftCardAPIService) GetGiftCard(ctx context.Context, giftCardCode string) ApiGetGiftCardRequest {
	return ApiGetGiftCardRequest{
		ApiService: a,
		ctx: ctx,
		giftCardCode: giftCardCode,
...
// Execute executes the request
//  @return GiftCard
func (a *CYSENDGiftCardAPIService) GetGiftCardExecute(r ApiGetGiftCardRequest) (*GiftCard, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CYSENDGiftCardAPIService.GetGiftCard")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/gift-card/{gift_card_code}"
	localVarPath = strings.Replace(localVarPath, "{"+"gift_card_code"+"}", url.PathEscape(parameterValueToString(r.giftCardCode, "giftCardCode")), -1)
...
type ApiPutActiveRequest struct {
	ctx context.Context
	ApiService *CYSENDGiftCardAPIService
	giftCardCode string
	active *bool
...
// Active flag
func (r ApiPutActiveRequest) Active(active bool) ApiPutActiveRequest {
	r.active = &active
	return r
}

func (r ApiPutActiveRequest) Execute() (*http.Response, error) {
	return r.ApiService.PutActiveExecute(r)
}

/*
PutActive Activates or deactivates a CY.SEND gift card

This operation activates or deactivates a CY.SEND gift card.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param giftCardCode CY.SEND gift card PIN code
 @return ApiPutActiveRequest
*/
func (a *CYSENDGiftCardAPIService) PutActive(ctx context.Context, giftCardCode string) ApiPutActiveRequest {
	return ApiPutActiveRequest{
		ApiService: a,
		ctx: ctx,
		giftCardCode: giftCardCode,
...
// Execute executes the request
func (a *CYSENDGiftCardAPIService) PutActiveExecute(r ApiPutActiveRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CYSENDGiftCardAPIService.PutActive")
	if err != nil {
