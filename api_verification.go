...
type ApiPhoneNumberVerificationRequestRequest struct {
	ctx context.Context
...
func (r ApiPhoneNumberVerificationRequestRequest) VerificationRequest(verificationRequest VerificationRequest) ApiPhoneNumberVerificationRequestRequest {
	r.verificationRequest = &verificationRequest
	return r
}

func (r ApiPhoneNumberVerificationRequestRequest) Execute() (*VerificationStatus, *http.Response, error) {
	return r.ApiService.PhoneNumberVerificationRequestExecute(r)
}

/*
PhoneNumberVerificationRequest Creates a phone number verification request
...
Use the PUT verification phone number [operation](#/Verification/phoneNumberVerify) to verify a request.
 ...
 @return ApiPhoneNumberVerificationRequestRequest
*/
func (a *VerificationAPIService) PhoneNumberVerificationRequest(ctx context.Context) ApiPhoneNumberVerificationRequestRequest {
	return ApiPhoneNumberVerificationRequestRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *VerificationAPIService) PhoneNumberVerificationRequestExecute(r ApiPhoneNumberVerificationRequestRequest) (*VerificationStatus, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *VerificationStatus
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VerificationAPIService.PhoneNumberVerificationRequest")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/verification/phone-number"
...
type ApiPhoneNumberVerifyRequest struct {
	ctx context.Context
	ApiService *VerificationAPIService
...
func (r ApiPhoneNumberVerifyRequest) Verification(verification Verification) ApiPhoneNumberVerifyRequest {
	r.verification = &verification
	return r
}

func (r ApiPhoneNumberVerifyRequest) Execute() (*VerificationStatus, *http.Response, error) {
	return r.ApiService.PhoneNumberVerifyExecute(r)
}

/*
PhoneNumberVerify Confirm a verification request

This operation checks if the correct verification code was received.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPhoneNumberVerifyRequest
*/
func (a *VerificationAPIService) PhoneNumberVerify(ctx context.Context) ApiPhoneNumberVerifyRequest {
	return ApiPhoneNumberVerifyRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return VerificationStatus
func (a *VerificationAPIService) PhoneNumberVerifyExecute(r ApiPhoneNumberVerifyRequest) (*VerificationStatus, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VerificationAPIService.PhoneNumberVerify")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
