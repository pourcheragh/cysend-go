...
// checks if the BeneficiaryInformation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BeneficiaryInformation{}
...
type _BeneficiaryInformation BeneficiaryInformation
...
func (o BeneficiaryInformation) MarshalJSON() ([]byte, error) {
...
func (o BeneficiaryInformation) ToMap() (map[string]interface{}, error) {
...
func (o *BeneficiaryInformation) UnmarshalJSON(data []byte) (err error) {
	...
	varBeneficiaryInformation := _BeneficiaryInformation{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBeneficiaryInformation)

	if err != nil {
		return err
	}

	*o = BeneficiaryInformation(varBeneficiaryInformation)

	return err
}

type NullableBeneficiaryInformation struct {
	value *BeneficiaryInformation
	isSet bool
}

func (v NullableBeneficiaryInformation) Get() *BeneficiaryInformation {
	return v.value
}

func (v *NullableBeneficiaryInformation) Set(val *BeneficiaryInformation) {
	v.value = val
	v.isSet = true
}

func (v NullableBeneficiaryInformation) IsSet() bool {
	return v.isSet
}

func (v *NullableBeneficiaryInformation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBeneficiaryInformation(val *BeneficiaryInformation) *NullableBeneficiaryInformation {
	return &NullableBeneficiaryInformation{value: val, isSet: true}
}

func (v NullableBeneficiaryInformation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBeneficiaryInformation) UnmarshalJSON(src []byte) error {
	v.isSet = true
