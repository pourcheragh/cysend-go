...
type Maintenance struct {
	...
	// Date and time of maintenance start in ISO8601 format
	StartTime string `json:"start_time"`
	// Date and time of maintenance start in ISO8601 format
	StopTime string `json:"stop_time"`
	// List of maintenance descriptions in various languages
	Descriptions []MaintenanceDescriptionsInner `json:"descriptions"`
}
...
func (o *Maintenance) GetDescriptions() []MaintenanceDescriptionsInner {
	if o == nil {
		var ret []MaintenanceDescriptionsInner
		return ret
	}
