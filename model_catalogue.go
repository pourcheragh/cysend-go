...
// checks if the Catalogue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Catalogue{}
...
type Catalogue struct {
	...
	FaceValues FaceValue `json:"face_values"`
	Maintenance []Maintenance `json:"maintenance"`
	Promotions []Promotion `json:"promotions,omitempty"`
}

type _Catalogue Catalogue
...
// GetFaceValues returns the FaceValues field value
...
// GetFaceValuesOk returns a tuple with the FaceValues field value
// and a boolean to check if the value has been set.
func (o *Catalogue) GetFaceValuesOk() (*FaceValue, bool) {
	if o == nil {
		return nil, false
	}
	return &o.FaceValues, true
}

// SetFaceValues sets field value
...
func (o Catalogue) MarshalJSON() ([]byte, error) {
...
func (o Catalogue) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["countries"] = o.Countries
	toSerialize["categories"] = o.Categories
	toSerialize["products"] = o.Products
	toSerialize["face_values"] = o.FaceValues
...
func (o *Catalogue) UnmarshalJSON(data []byte) (err error) {
	...
	varCatalogue := _Catalogue{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCatalogue)

	if err != nil {
		return err
	}

	*o = Catalogue(varCatalogue)

	return err
}

type NullableCatalogue struct {
	value *Catalogue
	isSet bool
}

func (v NullableCatalogue) Get() *Catalogue {
	return v.value
}

func (v *NullableCatalogue) Set(val *Catalogue) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogue) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogue(val *Catalogue) *NullableCatalogue {
	return &NullableCatalogue{value: val, isSet: true}
}

func (v NullableCatalogue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogue) UnmarshalJSON(src []byte) error {
	v.isSet = true
